...
# SVD
train_fold, valid_fold = run_svd_pipeline_user(
    train_fold,
    valid_fold,
    n_components=20,
...
ALL_FEATURES = {
    ...
    'hotel_performance': [
        ...
        'hotel_avg_gross_usd', 'hotel_revenue_zscore',
    ],
    ...
    # SVD pipeline
    'svd_interactions' : [ 
        'svd_dot_product', 'svd_interact_0', 'svd_interact_1', 'svd_interact_2', 'svd_interact_3',
...
def objective(trial: optuna.Trial) -> float:
    ...
    for group_name in ['competitor', 'search_context', 'user_history', 'basic_engineered', 'svd_interactions']:
